...
def get_deployment_key(pod_key: str) -> str:
    ...
    ReplicaSet hash length is not an API contract. The supported range covers
    the 8-character AIMS Deployment hash and 10-character Argo Rollout hashes
    observed on the production cluster, while retaining a strict pod suffix.
    """
    try:
