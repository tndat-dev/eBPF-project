...
| V8 fit/evaluation path | `build_phase_dataset.py`, `evaluate_aims_normal_split.py`, `run_aims_split_evaluation.sh` | native V8 split handling: run-01 fit only, run-02--06 one terminal independent evaluation; blocks evaluation while capture is active |
