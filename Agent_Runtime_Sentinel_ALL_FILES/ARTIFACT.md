...
| Paired syscall paper statistics | `ml-service/analyze_syscall_evaluation_matrix.py` | verifies identical injection outcomes across all methods; emits 55 exact McNemar/Holm comparisons, workload-block bootstrap, detected-latency CDF and censor-aware restricted time-to-detection |
